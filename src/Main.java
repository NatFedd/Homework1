public class Main {
    public static void main(String[] args) {
        ...
        int free = 7;
        if (one < two && two > free)
            System.out.println("Самым большим числом является two и оно равно " + two);
        if (two < one && one > free) {
            System.out.println("Самым большим числом является one и оно равно " + one);
        } else {
            System.out.println("Самым большим числом является free и оно равно " + free);
        }
